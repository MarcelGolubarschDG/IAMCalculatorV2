...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const Calculations = [
      { 
        id: 0, 
        basic:{calculationName: 'Kalkulation 1', calculationDesc: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem a'},
        customer:{customerName: 'BYI', customerNumber: 123, customerInternalEmployees: 1000, customerExternalEmployees: 200},
        marketunit:{marketunitName: 'DG OPS', marketunitResponsible: 'Hans Wurst'},
        targetsystems:{licenseOIM: 1, servicelevel: 1, stages: 1, antivirSrv: true, dedicatedSrv: true, amountMSAD: 1, amountMSAAD: 0, amountMSEX: 1, amountMSEXO: 0, amountMSSP: 0, amountMSSPO: 0, amountMSTEAMS: 0, amountFS: 0, amountSAPHCMCSV: 0, amountSAPHCM: 0, amountSAPAPP: 0, amountLDAP: 0, amountSTAR: 1, cloudProducts: 'ServiceNow'},
        servers: [
      ...
      { 
        id: 1, 
        basic:{calculationName: 'Kalkulation 2', calculationDesc: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem a'},
        customer:{customerName: 'BYI', customerNumber: 123, customerInternalEmployees: 1000, customerExternalEmployees: 200},
        marketunit:{marketunitName: 'DG OPS', marketunitResponsible: 'Hans Wurst'},
        targetsystems:{licenseOIM: 2, servicelevel: 2, stages: 2, antivirSrv: true, dedicatedSrv: true, amountMSAD: 1, amountMSAAD: 0, amountMSEX: 1, amountMSEXO: 0, amountMSSP: 0, amountMSSPO: 0, amountMSTEAMS: 0, amountFS: 0, amountSAPHCMCSV: 0, amountSAPHCM: 0, amountSAPAPP: 0, amountLDAP: 0, amountSTAR: 1, cloudProducts: 'ServiceNow'},
        servers: [
